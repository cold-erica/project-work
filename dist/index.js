(function (factory) {
  ...
  var hasClass$1 = function hasClass(elem, className) {
  ...
  var applyCustomClass = function applyCustomClass(elem, params, className) {
    ...
    if (params.customClass && params.customClass[className]) {
      ...
      addClass$1(elem, params.customClass[className]);
    }
  };
  ...
  var toggleClass$1 = function toggleClass(target, classList, condition) {
    if (!target || !classList) {
      return;
    }
  ...
  var addClass$1 = function addClass(target, classList) {
    toggleClass$1(target, classList, true);
  };
  var removeClass$1 = function removeClass(target, classList) {
    toggleClass$1(target, classList, false);
  };
  var getChildByClass = function getChildByClass(elem, className) {
    for (var i = 0; i < elem.childNodes.length; i++) {
      if (hasClass$1(elem.childNodes[i], className)) {
  ...
  var resetOldContainer = function resetOldContainer() {
    ...
    removeClass$1([document.documentElement, document.body], [swalClasses['no-backdrop'], swalClasses['toast-shown'], swalClasses['has-column']]);
  };
  ...
  var setupRTL = function setupRTL(targetElement) {
    if (window.getComputedStyle(targetElement).direction === 'rtl') {
      addClass$1(getContainer(), swalClasses.rtl);
    }
  };
  /*
  ...
  var renderActions = function renderActions(instance, params) {
    ...
    if (params.buttonsStyling) {
      ...
      removeClass$1([confirmButton, cancelButton], swalClasses.styled);
  ...
  function handleButtonsStyling(confirmButton, cancelButton, params) {
    addClass$1([confirmButton, cancelButton], swalClasses.styled); // Buttons background colors
  ...
  function renderButton(button, buttonType, params) {
    ...
    addClass$1(button, params["".concat(buttonType, "ButtonClass")]);
  }
  ...
  function handleBackdropParam(container, backdrop) {
    if (typeof backdrop === 'string') {
      ...
      addClass$1([document.documentElement, document.body], swalClasses['no-backdrop']);
    }
  }

  function handlePositionParam(container, position) {
    if (position in swalClasses) {
      addClass$1(container, swalClasses[position]);
    } else {
      warn('The "position" parameter is not valid, defaulting to "center"');
      addClass$1(container, swalClasses.center);
    }
  }
  ...
  function handleGrowParam(container, grow) {
    if (grow && typeof grow === 'string') {
      ...
      if (growClass in swalClasses) {
        addClass$1(container, swalClasses[growClass]);
      }
    }
  }
  ...
  var setCustomClass = function setCustomClass(params) {
    ...
    if (params.customClass) {
      addClass$1(inputContainer, params.customClass.input);
    }
  };
  ...
  var renderIcon = function renderIcon(instance, params) {
    ...
    if (Object.keys(iconTypes).indexOf(params.icon) !== -1) {
      ...
      addClass$1(icon, params.showClass.icon);
    } else {
  ...
  var createStepElement = function createStepElement(step) {
    ...
    addClass$1(stepEl, swalClasses['progress-step']);
  ...
  var createLineElement = function createLineElement(params) {
    ...
    addClass$1(lineEl, swalClasses['progress-step-line']);
  ...
  var renderProgressSteps = function renderProgressSteps(instance, params) {
    ...
    params.progressSteps.forEach(function (step, index) {
      ...
      if (index === currentProgressStep) {
        addClass$1(stepEl, swalClasses['active-progress-step']);
      }
  ...
  var renderPopup = function renderPopup(instance, params) {
    ...
    if (params.toast) {
      addClass$1([document.documentElement, document.body], swalClasses['toast-shown']);
      addClass$1(popup, swalClasses.toast);
    } else {
      addClass$1(popup, swalClasses.modal);
    } // Custom class
    ...
    if (typeof params.customClass === 'string') {
      addClass$1(popup, params.customClass);
    } // Animate class


    addClass$1(popup, params.showClass.popup);
  };
  ...
  var showLoading = function showLoading() {
    ...
    addClass$1([popup, actions], swalClasses.loading);
  ...
  function hideLoading() {
    ...
    removeClass$1([domCache.popup, domCache.actions], swalClasses.loading);
  ...
  var iOSfix = function iOSfix() {
    ...
    if (iOS && !hasClass$1(document.body, swalClasses.iosfix)) {
      var offset = document.body.scrollTop;
      document.body.style.top = "".concat(offset * -1, "px");
      addClass$1(document.body, swalClasses.iosfix);
      lockBodyScroll();
    }
  };
  ...
  var undoIOSfix = function undoIOSfix() {
    if (hasClass$1(document.body, swalClasses.iosfix)) {
      var offset = parseInt(document.body.style.top, 10);
      removeClass$1(document.body, swalClasses.iosfix);
  ...
  function removeBodyClasses() {
    removeClass$1([document.documentElement, document.body], [swalClasses.shown, swalClasses['height-auto'], swalClasses['no-backdrop'], swalClasses['toast-shown'], swalClasses['toast-column']]);
  }
  ...
  function close(resolveValue) {
    ...
    if (!innerParams || hasClass$1(popup, innerParams.hideClass.popup)) {
      return;
    }

    var swalPromiseResolve = privateMethods.swalPromiseResolve.get(this);
    removeClass$1(popup, innerParams.showClass.popup);
    addClass$1(popup, innerParams.hideClass.popup);
    var backdrop = getContainer();
    removeClass$1(backdrop, innerParams.showClass.backdrop);
    addClass$1(backdrop, innerParams.hideClass.backdrop);
  ...
  function showValidationMessage(error) {
    ...
    if (input) {
      ...
      focusInput(input);
      addClass$1(input, swalClasses.inputerror);
    }
  ...
  function resetValidationMessage$1() {
    ...
    if (input) {
      ...
      removeClass$1(input, swalClasses.inputerror);
    }
  }
  ...
  var addClasses$1 = function addClasses(container, popup, params) {
    addClass$1(container, params.showClass.backdrop);
    show(popup);
    addClass$1([document.documentElement, document.body], swalClasses.shown);

    if (params.heightAuto && params.backdrop && !params.toast) {
      addClass$1([document.documentElement, document.body], swalClasses['height-auto']);
    }
  };
  ...
  var swalPromise = function swalPromise(instance, domCache, innerParams) {
    return new Promise(function (resolve) {
      ...
      if (innerParams.toast && (innerParams.input || innerParams.footer || innerParams.showCloseButton)) {
        addClass$1(document.body, swalClasses['toast-column']);
      } else {
        removeClass$1(document.body, swalClasses['toast-column']);
      }
  ...
  function update$1(params) {
    ...
    if (!popup || hasClass$1(popup, innerParams.hideClass.popup)) {
  ...
  function () {
    ...
    _createClass(Application, [{
      ...
      value: function setupFeedbackForm() {
        var el = document.querySelector('.js-form-button');
        el.addEventListener('click', function (e) {
          var name = document.querySelector('.js-form-name').value;
          var email = document.querySelector('.js-form-email').value;
          var contact = document.querySelector('.js-form-contact').value;
          ...
          Swal.fire({
            title: 'Success!',
            text: "Hello ".concat(name, ", your feedback is sent to our support wait an answer to ").concat(email),
            icon: 'success',
